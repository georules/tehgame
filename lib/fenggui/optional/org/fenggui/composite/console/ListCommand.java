 ...
 * $Id: ListCommand.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
...
public class ListCommand implements ICommand
{
  ...
  public void execute(PrintStream out, Console source, String[] args)
  {
    ...
    for (File file : list)
    {
      ...
      out.print(" " + ensureLength(c.get(Calendar.DAY_OF_MONTH), 2, '0') + "-"
          + ensureLength(c.get(Calendar.MONTH), 2, '0') + "-" + ensureLength(c.get(Calendar.YEAR), 2, '0') + " ");
