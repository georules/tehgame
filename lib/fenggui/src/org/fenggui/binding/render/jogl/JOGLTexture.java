...
public class JOGLTexture implements ITexture
{
   ...
   * @throws IOException 
   */
  public JOGLTexture(InputOnlyStream stream) throws IOException, IXMLStreamableException
  {
    process(stream);
  }
  ...
  */
  ...
  public static JOGLTexture uploadTextureToVideoRAM(GL gl, BufferedImage awtImage)
  {
    ...
    gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGBA, texWidth, texHeight, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE,
      textureBuffer);
