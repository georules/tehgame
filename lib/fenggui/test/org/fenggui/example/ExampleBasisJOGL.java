 ...
 * 
 * $Id: ExampleBasisJOGL.java 620 2009-04-12 12:14:22Z marcmenghin $
 */
 ...
 * the JOGL-Binding.
 * 
 * @author Johannes, last edited by $Author: marcmenghin $, $Date: 2009-04-12 14:14:22 +0200 (So, 12 Apr 2009) $
...
public class ExampleBasisJOGL extends JFrame
{
  ...
  private class GLEventListenerImplementation implements GLEventListener
  {
    ...
    public void display(GLAutoDrawable arg0)
    {
      ...
      //render3DBackgroundFengGUISign();

      display.display();
      screenshotActor.renderToDos(display.getBinding().getOpenGL(), display.getWidth(), display.getHeight());
    }

    private void render3DBackgroundFengGUISign()
    {
      glu.gluLookAt(0, 0, 800, 0, 230, 0, 0, 0, 1);
      ...
      double delta = (currentFrame - lastFrame) * 0.0000001d;
  ...
  {
    //		JOGLBinding.EnableDebugingOnCanvas(canvas);
