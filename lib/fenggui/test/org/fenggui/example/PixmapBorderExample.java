 ...
 * 
 * $Id: PixmapBorderExample.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
...
public class PixmapBorderExample implements IExample
{
  ...
  public void buildGUI(Display display)
  {
    ...
    veryRightCont.setX(50);
    veryRightCont.setY(250);
    veryRightCont.getAppearance().add(new PlainBackground(Color.RED));

    Canvas veryRightCont2 = new Canvas();
    display.addWidget(veryRightCont2);
    veryRightCont2.setSize(150, 150);
    veryRightCont2.setX(250);
    veryRightCont2.setY(250);
    veryRightCont2.getAppearance().add(new PlainBackground(Color.RED));
    ...
    try
    {
      ...
      PixmapBorder border = new PixmapBorder(leftEdge, rightEdge, topEdge, bottomEdge, upperLeftCorner,
          upperRightCorner, lowerLeftCorner, lowerRightCorner);
      ...
      border = new PixmapBorder(leftEdge, rightEdge, topEdge, bottomEdge, upperLeftCorner, upperRightCorner,
      ...
      PixmapBorder16FixedCenters sixteenSlicesBorderFix = new PixmapBorder16FixedCenters(list);
      veryRightCont2.getAppearance().add(sixteenSlicesBorderFix);
    }
    catch (IOException e)
    {
      e.printStackTrace();
