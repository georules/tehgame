 ...
 * 
 * Created on 2005-3-1
 * $Id: MouseTestJOGL.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
...
public class MouseTestJOGL extends JFrame implements GLEventListener, MouseListener, MouseMotionListener
{
  ...
  */
  ...
  {
    boolean hitGUI = display.fireMousePressedEvent(me.getX(), display.getHeight() - me.getY(), EventHelper
        .getMouseButton(me), me.getClickCount());
  ...
  public void mouseReleased(MouseEvent me)
  {
    ...
    boolean hitGUI = display.fireMouseReleasedEvent(me.getX(), display.getHeight() - me.getY(), EventHelper
        .getMouseButton(me), me.getClickCount());
  }
  ...
  {
    @SuppressWarnings("unused")
    boolean hitGUI = display.fireMouseDraggedEvent(me.getX(), display.getHeight() - me.getY(), EventHelper
        .getMouseButton(me), me.getClickCount());
  }
  ...
  {
    @SuppressWarnings("unused")
    boolean hitGUI = display.fireMouseMovedEvent(me.getX(), display.getHeight() - me.getY(), EventHelper
        .getMouseButton(me), me.getClickCount());
  }
